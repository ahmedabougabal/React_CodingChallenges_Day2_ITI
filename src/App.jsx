...
export default function RequestTracker() {
  ...
  // 2. Fix a request counter
  // You’re working on an art marketplace app that lets the
  // user submit multiple orders for an art item at the s
  // ame time. Each time the user presses the “Buy” button,
  ...
  //And if you click fast twice, both counters seem to
